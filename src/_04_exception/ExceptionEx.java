...
// => Java 는 예외가 발생하면 예외 클래스로부터 객체 생성하며, 해당 객체는 예외 처리 시 사용됨
// 예외 발생 시 프로그램의 갑적스런 종료를 막고 정상 실행할 수 있도록 처리하는 코드를 예외 처리 코드라고 함
...
// 심지어 try 블록과 catch 블록에서 return 문을 사용해도 finally 는 항상 실행됨 (finally 생략 가능)
...
public class ExceptionEx {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //	at _04_exception.ExceptionEx.main(ExceptionEx.java:29)
        } finally {
