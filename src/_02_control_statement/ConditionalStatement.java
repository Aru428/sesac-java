...
public class ConditionalStatement {
    public static void main(String[] args) {
        ...
        String name = sc.nextLine(); // 엔터 이전까지의 문자열을 받음
...
//        }
        ...
        if(str1 == str2) {
            ...
            System.out.println("서로 다른 참조를 카리킴");
        }
        ...
        // 문자열 "동적 할당"의 경우, new String(...)을 사용해서 새로운 문자열 객체를 생성 -> 서로 다른 객체를 가르킴
        ...
        // switch ~ case 문
        // - 각 case 문의 break 문 선택사항, break 문 생략 시 바로 밑의 case 문으로 넘어감.
        String dayOfWeek;
        int day = 4;
